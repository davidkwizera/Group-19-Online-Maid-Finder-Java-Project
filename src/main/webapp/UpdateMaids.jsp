...
String sql ="select * from maids where mid="+s;
...
<form method="post" action="UpdateEmployerProcess.jsp"><div class="form">
...
<input type="text" name="email" value="<%=resultSet.getString("telephone") %>"></td></tr>
<br>
...
<tr><td>Address</td><td>
<input type="text" name="address" value="<%=resultSet.getString("address") %>"></td></tr>
<tr><td>Years Of Experience</td><td>
<input type="text" name="experience" value="<%=resultSet.getString("experience") %>"></td></tr>
<tr><td>Id Number</td><td>
<input type="text" name="id_number" value="<%=resultSet.getString("id_number") %>"></td></tr>
<tr><td>Work Type</td><td>
<input type="text" name="work_type" value="<%=resultSet.getString("work_type") %>"></td></tr>
<tr><td>Status</td><td>
<input type="text" name="status" value="<%=resultSet.getString("status") %>"></td></tr>
<br><br>
